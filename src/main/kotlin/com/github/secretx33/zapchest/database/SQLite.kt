...
//    }
    ...
    private companion object {
        ...
        // create tables
        @Language("SQL") const val CREATE_STORAGE_GROUPS = "CREATE TABLE IF NOT EXISTS storageGroups(group_name VARCHAR(100) NOT NULL PRIMARY KEY, owner VARCHAR(60) NOT NULL PRIMARY KEY, members VARCHAR(10000) NOT NULL, senders VARCHAR(10000) NOT NULL, receivers VARCHAR(10000) NOT NULL);"
